...
- 十八款即开即玩的 Web 玩法：斗地主竞技局，以及 KAI 象棋、KAI 五子棋、KAI 黑白棋、四人基础麻将、1048、6×6 KAI 数独、KAI 扫雷、KAI 推箱子、KAI 数字华容道、KAI 记忆翻牌、KAI 三消、KAI 方块、KAI 贪吃蛇、KAI 迷宫、KAI 农场、炸金花和算力转轮十七款免费训练
- 游戏中心支持中文/英文别名即时搜索，以及可继续、5 分钟、牌桌、棋类、益智、街机和自动保存筛选；“全部玩法”以类似中文小游戏门户的小图标网格展示，桌面与手机分别按可用宽度快速排布
- 小图标入口均可直接开局，筛选结果会原位重排而不劫持页面横向手势；规则页提供十八款游戏的完整目标、循环、终局、时长与保存边界
...
- KAI 农场提供播种、浇水、成熟与收获循环；离开页面后作物可按时间继续成熟，但不会自动产币，当前不支持好友拜访、偷菜或跨设备同步
