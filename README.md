...
- 十五款即开即玩的 Web 玩法：斗地主竞技局，以及 KAI 象棋、KAI 五子棋、KAI 黑白棋、四人基础麻将、1048、6×6 KAI 数独、KAI 扫雷、KAI 推箱子、KAI 数字华容道、KAI 记忆翻牌、KAI 贪吃蛇、KAI 农场、炸金花和算力转轮十四款免费训练
- 游戏中心支持中文/英文别名即时搜索，以及可继续、5 分钟、牌桌、棋类、益智、街机和自动保存筛选；桌面单排同时展示约五张玩法卡
- 全部玩法支持箭头、键盘、鼠标拖拽与触屏滑动，卡片吸附、首尾状态和“当前玩法”速览实时联动；规则页提供十五款游戏的完整目标、循环、终局、时长与保存边界
...
- 1048、数独、象棋、扫雷、五子棋、黑白棋、推箱子、数字华容道、记忆翻牌、贪吃蛇与 KAI 农场共十一款玩法支持当前浏览器本地自动保存
